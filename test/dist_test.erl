...
test_1()->
  ...
  %% N1 ---------------------------------------------------------------------------------
    ok=rpc:call(N1,application,load,[control],5000),
    ok=rpc:call(N1,application,start,[control],5000),
   ...
   % rpc:call(N1,mnesia,system_info,[],5000),
    ...
    %% N2 -----------------------------------------------------------------------------
    ok=rpc:call(N2,application,load,[control],5000),
    ok=rpc:call(N2,application,start,[control],5000),
  ...
  %% N3 -----------------------------------------------------------------------------------
    ok=rpc:call(N3,application,load,[control],5000),
    ok=rpc:call(N3,application,start,[control],5000),
    pong=rpc:call(N3,dbetcd,ping,[],5000),

    ['do_test@c50','n0@c50','n1@c50','n2@c50']=lists:sort(rpc:call(N3,mnesia,system_info,[db_nodes],5000)),
 ...
 %% N4 -----------------------------------------------------------------------------------------
   ...
   % N3='c3@c50',
    ...
    ok=rpc:call(N31,application,start,[control],5000), 
    pong=rpc:call(N31,dbetcd,ping,[],5000),
